...
//=========================  /*show noticia*/  ================================= 
    ...
    noticias.on('value', function(snapshot) {
        snapshot.forEach(function(childSnapshot) {
            ...
            var id = "<div class='col-md-2 text-center hidden-xs'><p style='font-size:12px;'>"+childKey+"</p></div> <div class='col-xs-12 visible-xs'><p style='font-size:12px;'>"+childKey+"</p></div>";
