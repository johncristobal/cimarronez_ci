...
<html>
	...
	<meta name="keywords" content="chocolate, cacao, vainilla, artesanías, playeras, cimarronez" />
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
                    <div class="fh5co-item" style="margin-top: 15px;text-align: center;">
                        <a href="<?php echo base_url();?>productos/categorias/<?=$value->id;?>">
                            <img src="<?php echo base_url();?>images/<?=$value->nombre;?>/home.png" class="" alt="" style="height: 175px; text-align: center;max-width: 100%;border-radius: 30px; width: 100%"><br>
