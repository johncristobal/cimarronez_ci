	...
	<header id="fh5co-header" class="fh5co-cover " role="banner" style="background: #3b1e07;" data-stellar-background-ratio="0.5">
        ...
        <div class="animate-box">
            <div class="container">
                <div class="row-fluid">
                    <div class="col-md-5">
                        <p class="titleone"><b>Nombre categoria</b></p>
                        <p class="titletwo"><b>Descripcion categoria</b></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!--div class="animate-box">
            <div class="container">
                <div class="row-fluid">
                    <div class="col-md-12">
                        <img src="<?php echo base_url();?>images/back1.jpg" alt="" style=""/>
                    </div>
                </div>
            </div>
        </div-->
