...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	<body style="background: rgb(39, 18, 2);">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 text-center logo-wrap" style="background: rgba(0,0,0,0.5);">
                                            <div id="fh5co-logo"><a href="<?php echo base_url();?>">CIMARRONEZ<img src="<?php echo base_url();?>images/red.png" alt="" width="15" height="15"></a></div>
					</div>
