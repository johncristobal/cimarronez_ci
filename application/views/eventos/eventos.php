	...
	<div id="fh5co-blog" class="fh5co-section">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="<?php echo base_url();?>eventos/ver/1" class="blog-bg" style="background-image: url(<?php echo base_url();?>images/gallery_2.jpeg);"></a>
						<div class="blog-text">
							<span class="posted_on">Nov. 13th 2017</span>
							<h3><a href="<?php echo base_url();?>eventos/ver/1">Brigada tierra y libertad</a></h3>
							<p>Trabajos de reconstrucción, salud y cultura.</p>
							<ul class="stuff">
								<!--li><i class="icon-heart2"></i>1.2K</li>
								<li><i class="icon-eye2"></i>2K</li-->
								<li><a href="<?php echo base_url();?>eventos/ver/1">Leer más<i class=""></i></a></li>
							</ul>
						</div> 
					</div>
				</div>
