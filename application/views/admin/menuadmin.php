			...
			<div class="container">
				<div class="row">
					<!--div class="col-xs-12 text-center logo-wrap"-->
						<!--div id="fh5co-logo"><a href="index.html">CIMARRONEZ<img src="images/red.png" alt="" width="15" height="15"></a></div-->
                                                
					<div class="col-xs-12 text-right menu-1 menu-wrap">
					<br>
						<ul>
							<!--li class="active"><a href="index.html">Home</a></li-->
                                                        <li><a href="<?php echo base_url();?>admin/inicio"><img src="<?php echo base_url();?>images/red.png" alt="" width="25" height="25" style="margin-bottom: 10px;"> Inicio</a></li>
