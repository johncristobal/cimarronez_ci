...
<html>
	...
	<?php $this->load->view('head');?>
        <script>
            //debbuger;
            var idnota = '<?php if(isset($idMapa) && $idMapa != "") { echo $idMapa; }else{ echo "";} ?>';            
        </script>
        ...
        <div class="container" style="padding: 2em 0;">
            ...
            <div class="row">                                
                <div class="col-md-4 idfirebase">
                    <div class="form-group">
                    <label>Imagen:</label>
                    <input type="file" value="Buscar mapa" name="foto0" id="foto0" onchange="validar(this,0);"/>
                    <input type="hidden" value="" name="imagenMapa" id="imagenMapa"/>
                    </div>
                </div>              
            ...
            <div class="row">
                <div class="col-sm-12 text-right">
                    <div class="form-group text-right">
                        <br>
                        <button class="btn-lg btn-danger addnotice" style="width:250px;">Agregar mapa</button>
                    </div>
                </div>
            </div>
	...
	<?php $this->load->view('scripts');?>
        ...
        <script src="<?php echo base_url()?>js/addmapa.js"></script>
