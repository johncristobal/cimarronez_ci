            ...
            <div class="container">
                <div class="row">
                        <div class="col-md-4">
                            ...
                            <span style="font-size: 25px;">Diagnóstico comunitario de bienes naturales</span>
                            </div>
                            </div>
                            <p><br><br><br>
                                - Planeación ambiental participativa<br>
                            </p>
                        </div>
                        <div class="col-md-4">
                            <div class="col-md-11">
                            <div class="row" style="text-align: center; background-color: #d25500; border-radius: 25px;">
                                <span style="font-size: 25px;">Seguridad alimentaria</span>
                            </div>
                            </div><br>
                            <p>
                                <br>
                                - Soberanía alimentaria y agricultura sustentable (agroecología)<br>
                ...
                <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="col-md-11">
                            <div class="row" style="text-align: center; background-color: #d25500; border-radius: 25px;">
                            <span style="font-size: 25px;">Fondos comunitarios de ahorro y préstamo</span>
                            </div>
                            </div>
                        </div>                        
                </div>  
